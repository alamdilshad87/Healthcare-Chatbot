...
class ChatApplication:
    ...
    def _get_name(self):
        self.window.title("Welcome to SRM Health Care Chatbot")
        ...
        made_by_label = Label(self.window, text="Faculty Mentor : Dr. S. Padmini \n Made by Dilshad Alam,Priyavratt & Shridhar", fg=TEXT_COLOR, bg=BG_COLOR, font=FONT_BOLD)
        made_by_label.place(relwidth=1, y=450)
        ...
        #about.add_command(label="Developers", command=lambda: self.msg_showinfo(f"Bot Develpoers ",f"\n\nGroup Members \n\n1. Md Dilshad Alam (917) 
       # \n2. Priyavratt (952) \n3. Shridhar Tiwari (925) \n Mentor : Dr. S. Padmini"),font="bold")
        #about.add_command(label="About Project", command=lambda: self.msg_showinfo(f"Bot V1.0.0 ",f" \tAbout Project \n\nThe primary goal of this 
       # project is to forecast the disease so that patients can get the desired output according to their primary symptoms.\n\n"),font="bold")


        about.add_command(label="Develpoers", command=lambda: self.msg_showinfo(f"Bot Develpoers ",f"\n\nFaculty Mentor: Dr. S. Padmini \n\nGroup Members \n\n1. Md Dilshad Alam (917)\n2. Priyavratt (953) \n3. Shridhar Tiwari (925)"),font="bold")
    ...
    def coming_msg(self):
        ...
        # msg = f"Hey! {good_name} ,Are you not feeling well? Please tell me what symptoms here are some examples: \n fever , cold , 
        # cough , headache , stomach_pain , abdominal_pain , dehydration , swelling , acidity , \n itching , sneezing , vomiting , 
        # anxiety , etc.\nNote: Please use underscore( _ ) in place of spacing in the name of disease.\n\n"
